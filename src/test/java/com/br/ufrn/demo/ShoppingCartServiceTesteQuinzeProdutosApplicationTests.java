...
public class ShoppingCartServiceTesteQuinzeProdutosApplicationTests {
    ...
    public void testCheckout() {
        ...
        cart.setProducts(Arrays.asList(produto1, produto2, produto3, produto4, produto5, produto6, produto7, produto8,
